...
<html lang="zh-cn">
  <head>
    ...
    <link href="<?=HOME_ASSERTS;?>css/login.css" rel="stylesheet">
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand"><a href="<?=site_url();?>"><img src="<?=ASSETS;?>img/logo-lg.png"></a></h3>
          ...
          <div class="inner cover">
              <form class="form-signin" name="form1" method="post" action="<?=  site_url('/user/do_login');?>" role="form">
                ...
                <div class="my-from-middle">
                    <div class="form-group has-feedback">
                        ...
                        <input class="form-control" name="username" id="username" placeholder="请输入用户名或邮箱" required="" autofocus="" type="text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <img id="code" onclick="document.getElementById('code').src='<?=site_url('/user/login_code?tm=');?>'+Math.random()" src="<?=site_url('/user/login_code');?>" class="img-responsive img-rounded">
                        </div>
                    </div>
                </div>
                ...
                <div class="my-from-bottom">
                    <span class="checkbox">
                        ...
                        <a class="pull-right" href="<?=site_url('user/user_pwd_find');?>">忘记登录密码</a>
                      </span>
                    ...
                    <p class="text-right register" >
                        ...
                        <a href="<?=site_url('user/user_reg');?>">立即注册</a>
                    </p>
                </div>
              </form>
          </div>
