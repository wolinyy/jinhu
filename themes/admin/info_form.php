...
<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="row panel-title">
          <span class="col-xs-6"><?=isset($form)?"编辑":"信息添加";?></span>
    ...
    <form class="form-horizontal" id='form' data-url='/admin/info.html'>
        <div class="panel-body" data-url='/admin/info/submit'>
...
<!--                        <div class="col-xs-6 col-sm-12 col-md-6 col-lg-4">
                            <a href="javascript:;" class="thumbnail">
                              <img src="http://img.jh.cn/103/z84Rm2_800x450.jpg" class="img-thumbnail">
                            </a>
                            <div class="text-center btnDelDiv">
                                <button type="button" class="btn btn-default delImg">删除</button>
                                &nbsp;&nbsp;<button type="button" class="btn btn-default dragImg">拖放</button>
...
<!--            <div class="form-group require">
            ...
            <div class="form-group require"> 
                ...
                <div class="col-xs-6 col-sm-3">
                    <img id="code" onclick="document.getElementById('code').src='<?=site_url('admin/info/verify_code?tm=');?>'+Math.random()" src="<?=site_url('admin/info/verify_code');?>" class="img-responsive img-rounded">
                </div>
            </div>
            <div class="form-group"> 
...
<!--        <div class="coords" style="display:none;">
            <input type="hidden" class="x1" name="x1" value="0" />
            <input type="hidden" class="y1" name="y1" value="0" />
            <p>
                <span>当前截取图片尺寸：</span>&nbsp;&nbsp;
                宽：<input class="w" type="text" name="w" disabled="disabled" value="0" />px&nbsp;&nbsp;&nbsp;&nbsp;
                高：<input class="h" type="text" name="h" disabled="disabled" value="0" />px
            </p>
            <p style="display:;">长宽比例：
                <label><input type="radio" name="scale" value="0"/>不限制</label>
                <label><input type="radio" name="scale" value="1" checked="checked" />幻灯片</label>
                <label><input type="radio" name="scale" value="2" />封面</label>
                <label><input type="radio" name="scale" value="3" />2:1</label>
                <label><input type="radio" name="scale" value="4" />4:3</label>
            </p>
        </div>-->
      </div>
