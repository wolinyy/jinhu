...
<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title text-right">
          ...
          <div class="btn-toolbar">
            ...
            <div class="btn-group btn-group-sm">
                <button id='show_add' type="button" class="btn btn-default" data-url='/admin/group/show_form' data-modal='1'>添加</button>
                <button type="button" id="batch_del" class="btn btn-default" data-url='/admin/group/batch_del'>批量删除</button>
            </div>
          </div>
      </h3>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover">
        <thead data-get='/admin/group/get' data-add='/admin/group/add' data-edit='/admin/group/edit' data-del='/admin/group/del'>
            <tr>
                ...
                <th>
                    SSID策略组
                    <span class="label label-warning">utf-8</span>
                    <span class="label label-success">gb2312</span>
                    <span class="label label-primary">both</span>
                </th>
